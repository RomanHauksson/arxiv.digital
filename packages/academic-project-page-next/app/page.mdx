<Header>
  ...
  <Links>
    <Link url="https://github.com/RomanHauksson/academic-project-astro-template" icon={<Icon icon="ri:file-pdf-2-line" />}>Paper</Link>
    <Link url="https://github.com/RomanHauksson/academic-project-astro-template" icon={<Icon icon="ri:github-line" />}>Code</Link>
    <Link url="https://github.com/RomanHauksson/academic-project-astro-template" icon={<Icon icon="academicons:arxiv" />}>arXiv</Link>
    <Link url="https://github.com/RomanHauksson/academic-project-astro-template" icon={<Icon icon="ri:slideshow-2-line" />}>Slides</Link>
  </Links>
</Header>
